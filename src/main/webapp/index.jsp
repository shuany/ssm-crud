...
<!--引入jquery  
web路径：不以/开始的相对路径，找资源，以当前资源的路径为基准，容易出问题
以/开始的相对路径，找资源，以服务器的路径为基准(http://localhost:3306):需要加上项目名称
...
<body>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" name="email" class="form-control"
									id="email_update_input" placeholder="email@yushuang.com">
				...
				<div class="modal-body">
					...
					<form class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" name="email" class="form-control"
									id="email_add_input" placeholder="email@yushuang.com">
								<span class="help-block"></span>
							</div>
						</div>
	...
	<div class="container">
		...
		<div class="row">
			...
			<!-- 分页条信息 -->
			<div class="col-md-6" id="page-nav_area"></div>
		</div>
	...
	<script type="text/javascript">
		...
		function build_page_info(result) {
			$("#page-info_area").empty();
			$("#page-info_area").append(
		...
		function getDepts(ele) {
			...
			$.ajax({
				...
				type : "GET",
				success : function(result) {
					//{"code":100,"extend":{"depts":[{"deptId":1,"deptName":"开发部"},{"deptId":2,"deptName":"测试部"}]},"msg":"处理成功"}
					//console.log(result);
		...
		//1、可以再创建按钮的时候绑定单击事件 2、 绑定单击   .live()
